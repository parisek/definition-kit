...
final class PropReads
{
     ...
     * @param list<array{path: string, literal: string}> $comparisons `<path> == '<literal>'`
     *   reads against a string constant, statically resolvable without evaluating the template
     */
